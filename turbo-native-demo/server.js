...
app.get("/tab", (req, res) => {
  res.render("tabbed/index", { title: "Tabbed" })
});
app.get("/tab1", (req, res) => {
  res.render("tabbed/tab1", { title: "Tab 1" })
});
app.get("/tab2", (req, res) => {
  res.render("tabbed/tab2", { title: "Tab 2" })
});
app.get("/tab2/new", (req, res) => {
  res.render("tabbed/modal", { title: "Tab 2" })
});
app.get("/tab2/after", (req, res) => {
  res.render("tabbed/after_modal", { title: "Tab 2" })
});
